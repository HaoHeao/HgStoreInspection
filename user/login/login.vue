    ...
    <view class="container">
        <view v-if="loading">
            ...
            <view class="input-view">
                ...
                <input type="number" placeholder-style="color:#B6C6D6;" class="input username fadeIn" placeholder="手机号/工号"
                    v-model="username">
            </view>
            <view class="input-view">
                <view class="icon">
                ...
                <input type="password" placeholder-style="color:#B6C6D6;" class="input pwd fadeIn" placeholder="密码"
                    v-model="password">
            </view>
